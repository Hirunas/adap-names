...
export abstract class AbstractName implements Name {
    ...
    public setComponent(i: number, c: string): Name {
        ...
        const result = this.doSetComponent(i, c);
        result as AbstractName;
        (result as AbstractName).assertInvariant();
        return result;
    }
    ...
    public insert(i: number, c: string): Name {
        this.assertValidIndexPrecondition(i);
        this.assertValidComponentPrecondition(c);
        const result = this.doInsert(i, c);
        result as AbstractName;
        (result as AbstractName).assertInvariant();
        return result;
    }
